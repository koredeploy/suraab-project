        ...
        <div className="grid grid-cols-1 gap-20">
          <div className="flex flex-col lg:flex-row gap-5 items-center ">
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <p className=" text-center lg:text-start">
                ...
                eu quam quisque nunc in. Nam <br /> auctor vulputate ultrices
                tincidunt. Mus quis dignissim adipiscing viverra et. Rutrum sit <br />
                sem pellentesque laoreet arcu nisl imperdiet. Sodales lectus
                consequat dignissim <br /> facilisis in at in vivamus magna.
              </p>
              <h4 className="medium text-center lg:text-start">Our Installation Methods</h4>
              <div className="flex  gap-2 items-center">
                <span>
                  <img src={check} alt="" />
                </span>
                <p>
                  We bring a level of craftsmanship to our projects that <br />
              ...
              <div className="flex gap-2 items-center ">
                ...
                <p className="pb-2">
                  Subhar Electricals introduces innovative practices to <br /> enhance
                  the efficiency and sustainability of electrical <br /> systems.
                </p>
              </div>
          ...
          <div className="flex flex-col lg:flex-row gap-5 items-center ">
            ...
            <div className="grid grid-cols-1 gap-3">
              ...
              <h4 className="medium-text text-center lg:text-start">Our Installation Methods</h4>
              <div className="flex gap-2 items-center">
                <span>
                  <img src={check} alt="" />
                </span>
