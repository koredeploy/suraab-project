...
const HeroSection = () => {
  return (
    <div>
       ...
       <div className=' absolute  left-0 right-0 flex top-16 lg:top-24 z-40 justify-center items-center lg:justify-start transform translate-y-[7%]'>
          <div className='w-11/12 mx-auto responsive pt-3 lg:pt-8'>
          <div className= 'w-full pt-5 lg:w-1/2 '>
           <h1 className='w-full hero-text text-white-100 text-center lg:text-start pt-3 md:pt-10'><span className='hero-text text-red-400 text-center lg:text-start'>Illuminate</span> Your Home  With Suraab Electrical Services</h1>
